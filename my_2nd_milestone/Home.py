...
# Replace <username>, <password>, and <database> with your actual details
client = MongoClient(
    "mongodb+srv://sariyamazhar27:Sariya%4027@sariya.r2x98.mongodb.net/?retryWrites=true&w=majority&appName=Sariya",
    tls=True,
    tlsCAFile=ca
)
...
if st.button("Submit Booking"):
    if name and customer_id:
        ...
        features = list(pd.read_excel('customer_features.xlsx')[0])
